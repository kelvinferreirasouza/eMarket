...
class CreateTableProduto extends Migration
{
    ...
    public function up()
    {
        Schema::create('produto', function (Blueprint $table) {	
            ...
            $table->string('qtdMin', 20, 3)->default(0.000);
            $table->decimal('precoCusto', 20, 2)->default(0.00);
            $table->decimal('precoVenda', 20, 2)->default(0.00);
            $table->decimal('margemLucro', 20, 2)->default(0.00);
            ...
            $table->integer('produtoMarcaId')->unsigned();
