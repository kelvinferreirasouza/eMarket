                ...
                <div class="card">
                    <div class="card-header card-header-flex">
                        ...
                        <a href="" data-toggle="modal" data-target="#modalCadastrar" >
                            <button type="button" class="btn btn-primary waves-effect waves-light btnCadUser"><i class="fa fa-user-plus"></i>Cadastrar Pedido</button></a>
                            ...
                            <div class="modal-dialog modal-lg modalProd" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #0cb6734 !important; color: white">
                                        <h5 class="modal-title" id="exampleModalLongTitle" style="color: #fff">PEDIDOS<i class="fa fa-help"></i></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true" style="color: #fff">×</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="{{route ('salvarPedido')}}" class="formEditUser">
                                            {{ csrf_field() }}
                                            <div class="card-header">
                                                <CENTER><h5>Cadastrar Pedido</h5></CENTER>
                                            </div>
                                            <div class="card-block">
                                                <div class="card-block">
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <label for="clienteId" class="control-label labelInputEditUser">Cliente:</label>
                                                            <select class="form-control labelInputEditUser" name="clienteId" id="clienteId">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label for="empresaId" class="control-label labelInputEditUser">Empresa:</label>
                                                            <select class="form-control labelInputEditUser" name="empresaId" id="clienteId">
                                                                <option value="">Selecione..</option>
