                                    ...
                                    <tbody>            
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                                    ...
                                                                                    <div id="home{{$pedido->id}}" class="container tab-pane active"><br>
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-6">
                                                                                                ...
                                                                                                <input disabled type="text" class="form-control" name="referencia" value="{{$pedido->referencia}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <a href="" data-toggle="modal" data-target="#modalVisualizar{{$pedido->id}}" data-whatever="{{$pedido->id}}" data-whateverclienteId="{{$pedido->cliente_id}}" data-whateverreferencia="{{$pedido->referencia}}" data-whatevercodigo="{{$pedido->codigo}}" data-whatevertotal="{{$pedido->total}}" data-whateverfrete="{{$pedido->frete}}" data-whateverstatus="{{$pedido->status}}" data-whatevermetodoPagamento="{{$pedido->metodo_pagamento}}" data-whateverdata="{{$pedido->data}}" data-whateverdataRefreshStatus="{{$pedido->data_refresh_status}}"><img src="../../imgs/iconView.png" title="Visualizar Produto" class="btnAcoes"></a>

                                                <!-- MODAL DE VISUALIZAR -->
                                                <div class="modal fade" id="modalVisualizar{{$pedido->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                                    ...
                                                                    <div class="card-block">
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-12">
                                                                                <ul class="nav nav-tabs" role="tablist">
                                                                                    <li class="nav-item">
                                                                                        <a class="nav-link active" data-toggle="tab" href="#visualizarPedido{{$pedido->id}}">Pedido</a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a class="nav-link" data-toggle="tab" href="#visualizarProdutos{{$pedido->id}}">Produtos</a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a class="nav-link" data-toggle="tab" href="#visualizarEndereco{{$pedido->id}}">Entrega</a>
                                                                                    </li>
                                                                                </ul>

                                                                                <!-- Tab panes -->
                                                                                <div class="tab-content">
                                                                                    <div id="visualizarPedido{{$pedido->id}}" class="container tab-pane active"><br>
                                                                                        <div class="row">
                                                                                            <div class="col-sm-2">
                                                                                                <label for="data" class="control-label labelInputEditUser">Nº Pedido:</label>
                                                                                                <input disabled type="text" class="form-control" name="data" value="{{$pedido->id}}" required>
                                                                                            ...
                                                                                            <div class="col-sm-3">
                                                                                                ...
                                                                                                ?>
                                                                                                <label for="data" class="control-label labelInputEditUser">Data:</label>
                                                                                                <input disabled type="date" class="form-control" name="data" value="{{$dataPedido}}" required>
                                                                                            </div>
                                                                                            <div class="col-sm-7">
                                                                                                <label for="cliente_id" class="control-label labelInputEditUser">Nome do Cliente:</label>
                                                                                                <select disabled class="form-control labelInputEditUser" name="cliente_id" id="cliente_id" value="{{$pedido->cliente_id}}">
                                                                                            ...
                                                                                            <div class="col-sm-4">
                                                                                                <label for="metodo_pagamento" class="control-label labelInputEditUser">Forma de Pagamento:</label>
                                                                                                <select disabled class="form-control labelInputEditUser" name="metodo_pagamento">
                                                                                                    <option disabled value="1" {{ $pedido->metodo_pagamento == 1 ? 'selected' : ''}}>Cartão de Crédito</option>
                                                                                                    <option disabled value="2" {{ $pedido->metodo_pagamento == 2 ? 'selected' : ''}}>Boleto Bancário</option>
                                                                                                    <option disabled value="4" {{ $pedido->metodo_pagamento == 4 ? 'selected' : ''}}>Saldo PagSeguro</option>
                                                                                                    <option disabled value="7" {{ $pedido->metodo_pagamento == 7 ? 'selected' : ''}}>Débito em Conta</option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <div class="col-sm-4">
                                                                                                <label for="cliente_id" class="control-label labelInputEditUser">Status:</label>
                                                                                                <select disabled class="form-control labelInputEditUser" name="status">
                                                                                                    <option disabled value="1" {{ $pedido->status == 1 ? 'selected' : ''}}>Aguardando Pagamento</option>
                                                                                                    <option disabled value="2" {{ $pedido->status == 2 ? 'selected' : ''}}>Em Análise</option>
                                                                                                    <option disabled value="3" {{ $pedido->status == 3 ? 'selected' : ''}}>Pagamento Aprovado</option>
                                                                                                    <option disabled value="4" {{ $pedido->status == 4 ? 'selected' : ''}}>Disponível</option>
                                                                                                    <option disabled value="5" {{ $pedido->status == 5 ? 'selected' : ''}}>Em Disputa</option>
                                                                                                    <option disabled value="6" {{ $pedido->status == 6 ? 'selected' : ''}}>Pagamento Devolvido</option>
                                                                                                    <option disabled value="7" {{ $pedido->status == 7 ? 'selected' : ''}}>Cancelado</option>
                                                                                                    <option disabled value="9" {{ $pedido->status == 9 ? 'selected' : ''}}>Retenção Temporária</option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <div class="col-sm-2">
                                                                                                <label for="total" class="control-label labelInputEditUser">Valor Total:</label>
                                                                                    ...
                                                                                    <div id="visualizarProdutos{{$pedido->id}}" class="container tab-pane fade"><br>
                                                                                        <table class="table table-striped table-bordered table-hover nowrap">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th class="text-center"><i class="far fa-images"></i></th>
                                                                                    ...
                                                                                    <div id="visualizarEndereco{{$pedido->id}}" class="container tab-pane fade"><br>
                                                                                        @foreach($clientes as $cliente)
