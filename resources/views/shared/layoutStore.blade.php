...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/store/mobile.css') }}" type="text/css"/>
        <!-- Font Awesome -->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row row2">
                    <div class="col-sm-2">
                        ...
                        <h1 style="margin:0px;"><span class=""><a href="{{ route('index') }}"><img class="logoNav" src="{{ asset('../imgs/logoContorno2.png') }}"></a></span></h1>
                    </div>  
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="#">Link</a>
            <a href="#">Link</a>
            <a href="{{route('minhaConta')}}"><i class="far fa-address-card"></i> Minha Conta</a>
            <a class="profile-links" href="{{route('meusPedidos')}}"><i class="fas fa-dolly"></i> Meus Pedidos</a>
