                        ...
                        <div class="card-block">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="descricao" placeholder="Digite o nome do setor" value="{{$unidade->descricao}}" required>
                                </div>
                                <div class="col-sm-2">
                                        <label for="sigla" class="control-label labelInputEditUser">Sigla:</label>
                                        <input type="text" class="form-control" name="sigla" placeholder="Digite o nome do setor" value="{{$unidade->sigla}}" required>
                                    </div>
                                <div class="col-sm-2">
