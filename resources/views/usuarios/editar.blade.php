                    ...
                    <form method="post" action="{{route ('atualizar', $usuario->id)}}" class="formEditUser">
                        ...
                        <div class="card-header">
                            <div class="col-sm-2">
                                ...
                                <div class="col-sm-6"><button class="btn btn-warning btnCancelar"><a class="linkCancel" href="{{ route('listar') }}"><b>Voltar</b></a></button>  </div>
                                <div class="col-sm-6"><button type="submit" class="btn btn-primary btnSalvar" style="display: none">Salvar</button></div>
                            </div>
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input disabled type="password" class="form-control" name="senha">
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div class="card-header">
                            <div class="col-sm-2">
                                ...
                                <div class="col-sm-6"><button class="btn btn-danger btnCancelar"><a class="linkCancel" href="{{ route('listar') }}">Cancelar</a></button>  </div>
                                <div class="col-sm-6"><button type="submit" class="btn btn-primary btnSalvar">Salvar</button></div>
                            </div>
                            <h5>Editar Usuário</h5>
                        </div>
