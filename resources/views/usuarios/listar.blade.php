                                                            ...
                                                            <form method="post" action="{{route ('atualizarUsuario', $usuario->id)}}" class="formEditUser">
                                                                ...
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            <label for="bairro" class="control-label labelInputEditUser">Bairro:</label>
                                                                            <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Digite o Bairro" value="{{$usuario->bairro}}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-4">
                                                                            <label for="estado" class="control-label labelInputEditUser">Estado:</label>
                                                                            <input type="text" class="form-control" name="estado" id="estado" placeholder="Digite o Estado" value="{{$usuario->estado}}">
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <label for="municipio" class="control-label labelInputEditUser">Municipio:</label>
                                                                            <input type="text" class="form-control" name="municipio" id="cidade" placeholder="Digite o Municipio" value="{{$usuario->municipio}}">
                                                                        </div>
                                                                        <div class="col-sm-2">
